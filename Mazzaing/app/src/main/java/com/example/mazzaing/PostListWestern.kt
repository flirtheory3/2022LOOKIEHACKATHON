...
import kotlinx.android.synthetic.main.activity_post_list_western.mazzainglogo
...
class PostListWestern : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = ListAdapter(postList, LayoutInflater.from(this@PostListWestern))
        westernFoodListView.adapter = adapter
        //////
        westernFoodListView.setOnItemClickListener {parent, view, position, id ->
            val intent2 = Intent(this@PostListWestern, PostRead::class.java)
